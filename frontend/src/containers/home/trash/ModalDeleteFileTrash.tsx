...
const ModalDeleteFileTrash: React.FC = observer(() => {
  ...
  const onClickRight = () => {
    ...
    if (!file) return;
    dlete_file_mutation.mutate({ id: file.id, trash: true });
  ...
  return (
    <ModalSmall
      ...
      inputValue="Удалить файл окончательно?"
      buttonLeftText="Нет"
      buttonRightText="Да"
...
export default ModalDeleteFileTrash;
